                                                                    ...
                                                                    const int start_tick)
{
    ...
    //t0 = omp_get_wtime() ;
    auto t0 = CTime::now() ;
    std::cout<<"SetSample: View creation:"<<F(t0 - wstart) <<std::endl ;
    ...
    //t1 = omp_get_wtime() ;
    auto t1 = CTime::now() ; 
    std::cout<<"SetSample: nt,np :"<<F(t1-t0) <<std::endl ;
 ...
 */
    ...
    //t0 = omp_get_wtime() ;
    t0 = CTime::now() ;
    std::cout<<"SetSample: scan :"<<F(t0-t1) <<std::endl ;
    // debug:
    ...
    //t1 = omp_get_wtime() ;
    t1 = CTime::now() ;
    std::cout<<"SetSample: rand :"<<F(t1-t0) <<std::endl ;
    ...
    //t0 = omp_get_wtime() ;
    t0 = CTime::now() ;
    std::cout<<"SetSample: Pvec,Tvec,Weight :"<<F(t0-t1) <<std::endl ;
    ...
    //wend = omp_get_wtime();
    auto wend = CTime::now();
    g_get_charge_vec_time_part4 += F(wend-wstart) ;
    std::cout<<"SetSample: SetSamplingBatch :"<<F(wend-t0) <<std::endl ;
    std::cout <<"set_sampling_Time: "<< F(wend-wstart) <<std::endl;
...
//    wend = omp_get_wtime();
    ...
    g_get_charge_vec_time_part3 += F(wend - wstart);
    cout<<"ScatterAdd_Time : "<<F(wend-wstart) << endl ; 
    cout<<"reset Time : "<<F(t0-wend) << endl ; 
